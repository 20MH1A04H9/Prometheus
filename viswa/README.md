...
<h3 align="center">⚔️ Cybersecurity Engineer · SOC Builder · Threat Hunter · from India 💙</h3>
...
- 🔥 Core expertise — `ZTNA` · `Splunk` · `Wazuh` · `Windows AD` · `Pfsense` · `Fortigate`
...
- 📝 Read my [Cyber Creed](https://saiviswanadh.notion.site/Creed-14d5559fcb5a807a8cc8dd1a2c877f68?pvs=4) · Watch the [Live Cyber Map](https://cybermap.kaspersky.com/en/widget/dynamic/dark)
...
*Internship Certificates: Cyber & Forensics Security Solutions · Prodigy InfoTech · EduSkills Foundation (AWS)*
...
`Kali Linux` · `Parrot OS` · `Nmap` · `Metasploit` · `Burp Suite` · `Wireshark` · `BloodHound` · `Impacket` · `Nikto` · `Gobuster` · `SQLmap`
...
`Perplexity` · `ChatGPT` · `Gemini AI` · `Firebase Studio` · `MidJourney`
